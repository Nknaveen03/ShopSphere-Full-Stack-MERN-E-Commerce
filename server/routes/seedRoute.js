...
const sampleProducts = [
  { title: 'Wireless Noise-Cancelling Headphones', price: 2999, category: 'Electronics', brand: 'SoundMax', stock: 50, rating: 4.5, numReviews: 128, description: 'Premium wireless headphones with ANC technology', image: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=400' },
  { title: 'Mechanical Gaming Keyboard', price: 1499, category: 'Electronics', brand: 'KeyTech', stock: 35, rating: 4.3, numReviews: 89, description: 'RGB mechanical keyboard with Cherry MX switches', image: 'https://images.unsplash.com/photo-1541140532154-b024d705b90a?w=400' },
  { title: 'Wireless Charging Pad', price: 899, category: 'Electronics', brand: 'ChargeFast', stock: 65, rating: 4.3, numReviews: 211, description: '15W fast wireless charger, Qi compatible', image: 'https://images.unsplash.com/photo-1591815302525-756a9bcc3425?w=400' },
  { title: 'Portable Bluetooth Speaker', price: 1799, category: 'Electronics', brand: 'SoundMax', stock: 45, rating: 4.2, numReviews: 76, description: 'Waterproof speaker with 20hr battery life', image: 'https://images.unsplash.com/photo-1608043152269-423dbba4e7e1?w=400' },
  { title: 'Laptop Stand Adjustable', price: 1299, category: 'Electronics', brand: 'DeskPro', stock: 55, rating: 4.6, numReviews: 143, description: 'Aluminum adjustable laptop stand, fits 11-17"', image: 'https://images.unsplash.com/photo-1527864550417-7fd91fc51a46?w=400' },
  { title: 'USB-C Hub 7-in-1', price: 1099, category: 'Electronics', brand: 'DeskPro', stock: 75, rating: 4.4, numReviews: 223, description: 'HDMI 4K, 3x USB-A, SD card, PD charging', image: 'https://images.unsplash.com/photo-1625842268584-8f3296236761?w=400' },
  ...
  { title: "Men's Slim Fit Chinos", price: 1399, category: 'Clothing', brand: 'BasicWear', stock: 85, rating: 4.2, numReviews: 198, description: 'Stretch cotton slim fit chinos, multiple colours', image: 'https://images.unsplash.com/photo-1473966968600-fa801b869a1a?w=400' },
  { title: 'Slim Leather Wallet', price: 599, category: 'Clothing', brand: 'LeatherCo', stock: 100, rating: 4.7, numReviews: 245, description: 'Minimalist genuine leather bifold wallet', image: 'https://images.unsplash.com/photo-1627123424574-724758594e93?w=400' },
  { title: 'Sunglasses Polarised', price: 1199, category: 'Clothing', brand: 'LensKraft', stock: 70, rating: 4.4, numReviews: 178, description: 'UV400 polarised lenses with metal frame', image: 'https://images.unsplash.com/photo-1511499767150-a48a237f0083?w=400' },
